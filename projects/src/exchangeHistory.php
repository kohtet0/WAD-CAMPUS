    ...
    <main id="areaCalc">
        <div class="container mx-auto px-20 py-5">
            ...
            <div class="flex flex-col gap-3 items-center bg-neutral-600 rounded-lg py-10">
                <div class=" py-2 bg-neutral-50 border w-96 rounded-lg px-3 flex flex-col gap-2 items-start font-mono">
                    <?php
